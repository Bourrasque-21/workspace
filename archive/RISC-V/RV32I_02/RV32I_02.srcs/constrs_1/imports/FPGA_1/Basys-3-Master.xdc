...
create_generated_clock -name cpu_clk -source [get_ports clk] -divide_by 2 [get_pins cpu_clk_reg/Q]
...
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports {stop_sw}]
#set_property -dict { PACKAGE_PIN W17   IOSTANDARD LVCMOS33 } [get_ports {clear}]
